...
public class User {
    ...
    private User(Boolean anon, Gender gender, String name, String surname, int birthdate, String email) {
        this.anonflag = anon;
        this.gender = gender;
        this.name = name;
    ...
    public static User getUserInstance() {
        if(userInstance == null) {
            if(PreferencesManager.getPreferencesManagerInstance().checkForKey("USERDATA","user")) {
                ...
                try {
                    JSONObject userjson = PreferencesManager.getPreferencesManagerInstance().readJSONObjFromFile("USERDATA", "user");
                    String gender = userjson.getString("gender");
                    Gender g = getGenderFromString(gender);
                    userInstance = new User(userjson.getBoolean("anonflag"),g,userjson.getString("name"),userjson.getString("surname"),userjson.getInt("birthdate"),userjson.getString("email"));
                ...
                PreferencesManager.getPreferencesManagerInstance().writeJSONObjOnFile("USERDATA", "user", userInstance.serializeInJSON());
            }
        }
        return userInstance;
    }
